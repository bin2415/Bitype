...
class SanitizerArgs {
  ...
  //Added, to express the Bitype class inheritance relation file location
  // std::string RelationFileStr;
  //Added end
 ...
 public:
  ...
  //bool needsBitypeRt() const{ return Sanitizers.has(SanitizerKind::Bitype); }
