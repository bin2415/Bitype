...
private:
  ...
  struct CXXRecordLayoutInfo {
    ...
    /// HasOwnBTCPtr - Does this class provide a bitype code that is independent
    /// its base classes.
    //bool HasOwnBTCPtr : 1;
  ...
  ASTRecordLayout(const ASTContext &Ctx,
                  ...
                  CharUnits requiredAlignment,
                  bool hasOwnVFPtr, /*bool hasOwnBTCPtr*/ bool hasExtendableVFPtr,
                  CharUnits vbptroffset,
                  CharUnits datasize,
                  ArrayRef<uint64_t> fieldoffsets,
...
public:
  ...
  // bool hasOwnBTCPtr() const{
  //   assert(CXXInfo && "Record layout does not have C++ specific info!");
  //   return CXXInfo->HasOwnBTCPtr;
  // }
