...
private:
  ...
  /// respectively.const std::string relationPath
  ///
  ...
  /// \brief class which is in the class inheritance relationship
  //std::unique_ptr<std::map<std::string, unsigned> > SanitizerRS;

  //std::unique_ptr<std::map<std::string, unsigned> > SanitizerAliMap;
...
public:
  ...
  // const std::map<std::string, unsigned> &getSanitizerRelationSet() const{
  //   return *SanitizerRS;
  // }

  // const std::map<std::string, unsigned> &getSanitizerAlignment() const{
  //   return *SanitizerAliMap;
  // }

  //determine the class name if is in the relationset.
  // bool inRelationSet(std::string name) const{
  //    if(SanitizerRS->find(name) != SanitizerRS->end()){
  //      return true;
  //    }
  //    return false;
  // }
