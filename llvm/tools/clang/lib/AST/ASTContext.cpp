...
ASTContext::ASTContext(LangOptions &LOpts, SourceManager &SM,
  ...
  //if(LangOpts.Sanitize.has(SanitizerKind::Bitype)){
    //SanitizerRelation sr(LangOpts.SanitizerRelationFile);
    //SanitizerRS = sr.createCodeMap();
    //llvm::BitypeGetConfig bitypeUtils;
    //llvm::errs() << "code map variable is " << bitypeUtils.getCodeMapPath() << "\n";
    // SanitizerAliMap = sr.createAlignmentMap();
    // llvm::errs() << "I have got the class set, the set size is " << SanitizerRS->size() << "\n";
