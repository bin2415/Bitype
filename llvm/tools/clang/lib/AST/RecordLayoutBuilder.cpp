...
protected:
  ...
  /// HasOwnBTCPtr - Whether the class provides its own bitype code pointer,
  /// as opposed to inheriting one from a primary base class.
  /*bool HasOwnBTCPtr;*/
  ...
  ItaniumRecordLayoutBuilder(const ASTContext &Context,
      ...
      : Context(Context), EmptySubobjects(EmptySubobjects), Size(0),
        ...
        PrimaryBaseIsVirtual(false), HasOwnVFPtr(false), /*HasOwnBTCPtr(false)*/
...
void ItaniumRecordLayoutBuilder::LayoutNonVirtualBases(
  ...
  //Add this class needs a bitype code and didn't get one from a primary base, add it in now.
 /* if(!PrimaryBase && Context.getLangOpts().Sanitize.has(SanitizerKind::Bitype) && 
  Context.inRelationSet(RD->getName().str())){
    CharUnits PtrWidth = 
      Context.toCharUnitsFromBits(Context.getTargetInfo().getPointerWidth(0));
    CharUnits PtrAlign = 
      Context.toCharUnitsFromBits(Context.getTargetInfo().getPointerAlign(0));
...
public:
  ...
  /// don't support ms for now
  /// TODO, add support for ms
  //bool HasOwnBTCPtr : 1;
...
ASTContext::getASTRecordLayout(const RecordDecl *D) const {
  ...
  //llvm::errs() << "I am in astrecordlayout\n";
    ...
    if (const auto *RD = dyn_cast<CXXRecordDecl>(D)) {
      ...
      NewEntry = new (*this) ASTRecordLayout(
          *this, Builder.Size, Builder.Alignment, Builder.RequiredAlignment,
          Builder.HasOwnVFPtr, /*Builder.HasOwnBTCPtr,*/ Builder.HasOwnVFPtr || Builder.PrimaryBase,
    ...
    if (const auto *RD = dyn_cast<CXXRecordDecl>(D)) {
      ...
      NewEntry = new (*this) ASTRecordLayout(
          *this, Builder.getSize(), Builder.Alignment,
          ...
          Builder.Alignment, Builder.HasOwnVFPtr, /*Builder.HasOwnBTCPtr*/ RD->isDynamicClass(),
