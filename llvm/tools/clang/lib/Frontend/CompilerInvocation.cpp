...
// parse -fsanitize-relation= relation_file option
  // if(Arg *A = Args.getLastArg(OPT_fsanitize_relation)){
    
  //   Opts.SanitizerRelationFile = A->getValue();
  //   if(!llvm::sys::fs::exists(Opts.SanitizerRelationFile)){
  //     Diags.Report(diag::err_drv_no_such_file) << Opts.SanitizerRelationFile;
  //   }
  // }
