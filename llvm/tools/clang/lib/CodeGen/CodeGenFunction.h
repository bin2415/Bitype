...
public:
  ...
  //bitype added
  void BitypeEmitCheck(StringRef FunName, llvm::Value* Address1, llvm::Value* Address,
      unsigned index, unsigned char safeCode, int);
  
  void BitypeEmitObjTraceInst(const CXXRecordDecl*, llvm::Value*, uint64_t, char*);

  // void EmitBitypeReinterpretCast(Qual)
  //bitype added end
  ...
  // bitype added to handle reinterpret cast
  void EmitBitypeReinterpretCast(QualType T, llvm::Value *Derived, bool MayBeNull);
