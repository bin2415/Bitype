...
static void addBitypeInitializePass(const PassManagerBuilder &Builder,
                                    legacy::PassManagerBase &PM){
  PM.add(createBitypeInitializePass());
                                    }

static void addBitypePass(const PassManagerBuilder &Builder, 
                          legacy::PassManagerBase &PM){
  PM.add(createBitypePass());
                          }
...
void EmitAssemblyHelper::CreatePasses(legacy::PassManager &MPM,
  ...
  if (LangOpts.Sanitize.hasOneOf(SanitizerKind::Bitype)){
    //llvm::errs() << "add the extension\n";
    PMBuilder.addExtension(PassManagerBuilder::EP_ModuleOptimizerEarly,
      addBitypeInitializePass);
    PMBuilder.addExtension(PassManagerBuilder::EP_EnabledOnOptLevel0,
      addBitypeInitializePass);
