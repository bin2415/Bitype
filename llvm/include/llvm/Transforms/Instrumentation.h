...
// Insert bitype initialization pass
ModulePass *createBitypeInitializePass();

// Insert bitype stack/global object tracing instrumentation
ModulePass *createBitypePass();
